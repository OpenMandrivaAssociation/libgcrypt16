...
- do uclibc build
- don't disable use of random dev
- disable experimental random generator daemon
- %files cosmetics
- replace libgpg-error-devel build dependency with pkgconfig(gpg-error)
- removal of *.la files are now handled by spec-helper
- add pkgconfig support (P3, from OpenEmbedded)
- drop install-info scriptlet
- do not own %%{multiarch_bindir}
